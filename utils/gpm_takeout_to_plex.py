...
def main():
    ...
    parser.add_argument("--takeout-path", help="Path to extracted 'Takeout' directory", required=True)
    parser.add_argument("--output-path", help="Path to music library directory to output files too", required=True)
